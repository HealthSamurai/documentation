...
2. Now you can set up this parameter for the Aidbox database connection. Look at [Install Aidbox in Kubernetes](../getting-started-1/run-aidbox/run-aidbox-in-kubernetes/) tutorial
