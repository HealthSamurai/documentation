...
{% hint style="info" %}
Resources are stored in [Aidbox JSON format](../getting-started/aidbox-and-fhir-formats.md), which is more friendly for storage, and converted into FHIR in REST API on the fly!
{% endhint %}
