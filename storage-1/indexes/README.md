...
Aidbox provides a mechanism to manage indexes automatically using [Aidbox configuration project](broken-reference).
...
This RPC runs [workflow](broken-reference) that creates indexes requested by your configuration. And removes indexes not requested.
