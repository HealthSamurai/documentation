...
{% hint style="danger" %}
**SearchParameters:** SearchParameters described for custom resources won't work in FHIRSchema validation mode. You need to redefine them as regular FHIR SearchParameters, not Aidbox Search Parameters. See the [migration guide](../../../api-1/fhir-api/search-1/custom-search-parameter/migrate-from-aidbox-searchparameter-to-fhir-searchparameter.md).
{% endhint %}
