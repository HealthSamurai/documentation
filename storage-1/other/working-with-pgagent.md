...
You can see more info on [configuring aidboxdb](../../storage-1/aidboxdb-image/).
...
* You can configure `pgagent` using several variables described [here](../../storage-1/aidboxdb-image/#optional-environment-variables).
