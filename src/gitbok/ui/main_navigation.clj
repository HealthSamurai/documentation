     ...
     [:div {:class "flex items-center justify-between py-3 min-h-16 px-4 sm:px-6 md:px-8 max-w-screen-2xl mx-auto"}
      ...
      [:div {:class "flex items-center gap-6"}
       ...
       [:a {:href "https://aidbox.app/ui/portal#/signin"
            :class "hidden lg:inline-flex items-center justify-center px-4 py-2 text-sm font-semibold leading-5 text-on-surface hover:text-brand border border-outline hover:border-brand rounded-md transition-colors"
            :target "_blank"
