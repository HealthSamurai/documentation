   ...
   [:div {:class "flex items-center justify-between py-3 min-h-16 px-4 sm:px-6 md:px-8 max-w-screen-2xl mx-auto"}
    ...
    [:div {:class "flex items-center gap-4"}
     ...
     [:a {:href "/search"
          ...
          :hx-push-url "/search"
          :hx-swap "innerHTML"
          :class "search-button flex items-center gap-2 px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 text-sm transition-all duration-200 hover:bg-gray-200 hover:border-gray-400"}
