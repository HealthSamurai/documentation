...
* [AccessPolicy resource](../../modules-1/security-and-access-control/security/access-control.md) and
...
* _Parsed HTTP request._ It's an [internal representation](../../modules-1/security-and-access-control/security/access-control.md#request-object-structure) of the request, which Aidbox passes to the eval-policy function.
...
If you are looking for recommendations, how to develop access policies, check out our [AccessPolicy best practices article](../../modules-1/security-and-access-control/security/accesspolicy-best-practices.md).
