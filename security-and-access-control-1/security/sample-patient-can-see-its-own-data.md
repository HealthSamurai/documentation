...
To complete this tutorial, you should install Postman and get access to the Aidbox Console (see [here](../../getting-started/installation.md) how to install your Aidbox instance) .
