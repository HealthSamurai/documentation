...
The `access-token` field of `user-info` will be needed to perform requests on behalf of our User. See [here](../../user-management-1/auth/resource-owner-password.md#use-access-token) how to perform user request with a token.
