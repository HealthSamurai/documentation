...
There are two versions of this operation - `/fhir/$load` accepts data in FHIR format, `/$load` works with [Aidbox format](../../storage/other/aidbox-and-fhir-formats.md).
...
Load 100 synthea Patients to Aidbox (see [tutorial](../../readme/bulk-api-tutorials/synthea-by-bulk-api.md)):
