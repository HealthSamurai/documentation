...
[Create `GcpServiceAccount` resource](../../storage/other/s3-compatible-storages/gcp-cloud-storage.md) in Aidbox. Example:
...
[Create `AwsAccount` resource](../../storage/other/s3-compatible-storages/aws-s3.md) in Aidbox. Example:
...
Create [AWSAccount](../../storage/other/s3-compatible-storages/aws-s3.md) or [GCPServiceAccount](../../storage/other/s3-compatible-storages/gcp-cloud-storage.md), depending on your config.
