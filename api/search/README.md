...
{% hint style="info" %}
There are two versions of API, which differ by the [resources format](../../../storage/other/aidbox-and-fhir-formats.md):

* search by **`/[resourceType]`** returns results in [Aidbox Format](../../../storage/other/aidbox-and-fhir-formats.md)
