...
Let's upload some sample data using [Batch Upsert](https://github.com/Aidbox/documentation/blob/master/api/batch-upsert/README.md):
...
{% content-ref url="../../../../deprecated/other/custom-search.md" %}
[custom-search.md](../../../../deprecated/other/custom-search.md)
{% endcontent-ref %}
