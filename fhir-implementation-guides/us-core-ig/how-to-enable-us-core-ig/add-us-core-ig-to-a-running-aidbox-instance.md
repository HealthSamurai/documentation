...
Go to the main configuration file for your system (\`system.edn\` if you followed the guide above) and add `hl7-fhir-us-core` namespace to imports. It should look like this:
