...
{% hint style="info" %}
This article is work-in-progress. Please [contact us](../../../overview/contact-us.md) if you want to get details on how to create a custom zen profile.
{% endhint %}
...
Those schemas must be tagged with `zen.fhir/profile-schema`, describe data structure in the [Aidbox format](../../../getting-started/aidbox-and-fhir-formats.md) and conform to the following schema:
