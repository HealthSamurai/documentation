...
There are many ways you can [build multitenancy on top of Aidbox](../../security-and-access-control-1/security/multitenancy.md). Current section is going to focus on an upcoming into Aidbox first-class multitenancy, which will provide you a guided framework to built your own multitenant application on top of Aidbox.
