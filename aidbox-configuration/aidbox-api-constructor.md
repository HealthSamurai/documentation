...
{% content-ref url="../security-and-access-control-1/background-information/smart-app.md" %}
[smart-app.md](../security-and-access-control-1/background-information/smart-app.md)
{% endcontent-ref %}
