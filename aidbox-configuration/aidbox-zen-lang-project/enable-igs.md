...
Using the example from [the getting started page](../../getting-started/run-aidbox/run-aidbox-locally-with-docker.md#create-and-set-up-your-aidbox-configuration-project) the updated entrypoint file will look like this for both of the examples above:
...
<img src="../../.gitbook/assets/image (4) (1) (1).png" alt="" data-size="original">             ![](<../../.gitbook/assets/image (3) (3).png>)
