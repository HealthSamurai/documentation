...
{% hint style="info" %}
This functionality is available starting from version 2410 and requires [FHIR Schema](../../profiling-and-validation/fhir-schema-validator/) validation engine to be [enabled](broken-reference).
{% endhint %}
