...
Once you have your Smartbox instance [up and running](./README.md) you need to register a FHIR server by creating Tenant resource and upload necessary resources for Inferno.
