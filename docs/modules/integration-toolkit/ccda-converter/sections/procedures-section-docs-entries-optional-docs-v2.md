---
description: C-CDA Procedures section (/entries optional) (/V2) conversion rules and FHIR resource mapping for clinical document transformation.
---
...
<section>
   ...
   <code codeSystem="2.16.840.1.113883.6.1"
          ...
          code="47519-4"/>
   <title>Procedures Section (entries optional) (V2)</title>
   <text>
