---
description: C-CDA Medications Administered Section (/V2) conversion rules and FHIR resource mapping for clinical document transformation.
---
...
[IG Link](https://www.hl7.org/ccdasearch/templates/2.16.840.1.113883.10.20.22.2.38.html)
...
<section>
   ...
   <code codeSystem="2.16.840.1.113883.6.1"
          ...
          code="29549-3"/>
   <title>Medications Administered Section (V2)</title>
   <text>
