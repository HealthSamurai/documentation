...
Aidbox enables SMART App Launch with external identity providers. Set up an [Identity Provider](../../../../docs/modules/security-and-access-control/set-up-external-identity-provider/) in Aidbox to sign in via the provider during the launch. Try it with our pre-configured demo (e.g., Keycloak):
