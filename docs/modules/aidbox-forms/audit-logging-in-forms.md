...
For using user-token you should setup [TokenIntrospector](../../modules/access-control/authentication/token-introspector.md) or [IdentityProvider](../security-and-access-control/set-up-external-identity-provider/README.md) for validating this token.
