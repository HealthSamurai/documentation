---
description: >-
  Configure FHIR SDC form entry modes - sequential, prior-edit, or random - to
  control question presentation and navigation.
---
...
[Entry Mode](https://build.fhir.org/ig/HL7/sdc/StructureDefinition-sdc-questionnaire-entryMode.html) defines how questions are presented and navigated in your form. It controls whether users see one question at a time or all at once, and whether they can modify previous answers. This feature is particularly important when certain questions must be answered definitively before proceeding, or when viewing later questions might influence earlier responses.
...
{% hint style="info" %}
When Entry Mode is enabled, group items are flattened and displayed as individual questions without preserving group-level hierarchy to ensure a consistent step-by-step experience, and please note that Entry Mode currently does not support repeated items or multilingual forms, which may limit its use in such scenarios.
{% endhint %}
