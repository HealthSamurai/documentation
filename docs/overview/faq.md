...
Yes. Aidbox may send basic usage statistics to `https://ph.aidbox.app` to help improve the product. You can [read more and configure this behavior here](../reference/all-settings.md#usage-stats).
