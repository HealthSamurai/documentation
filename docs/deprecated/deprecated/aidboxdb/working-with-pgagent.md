...
You can see more info on [configuring aidboxdb](README.md).
...
* You can configure `pgagent` using several variables described in the [AidboxDB environment variables](../other/aidboxdb-environment-variables.md).
