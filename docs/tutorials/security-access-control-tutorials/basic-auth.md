...
<figure><img src="../../.gitbook/assets/0ad8b714-3ff8-4375-817b-a133aeaccc6a.png" alt="Sandbox UI for Basic Auth testing"><figcaption><p>Sandbox UI</p></figcaption></figure>

### Register Client

The first step is to create resource [Client](../../reference/system-resources-reference/core-module-resources.md) with id & secret and add `'basic'` to it's `grant_types` collection:
