...
2. Configure **Authorization** using&#x20;
   ...
   2.  Specify Username as `postman` and Password as `secret` \
       ...
       <figure><img src="../../.gitbook/assets/image (1).png" alt="Postman Basic Auth configuration with username and password fields"><figcaption><p>Postman</p></figcaption></figure>
