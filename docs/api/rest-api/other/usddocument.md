...
{% hint style="info" %}
$document operation uses several Search requests under the hood. These requests should be allowed by Access Policies. See [#setting-up-access-policies-for-usddocument-operation](document.md#setting-up-access-policies-for-document-operation)
{% endhint %}
