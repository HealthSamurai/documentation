...
Create a box here [https://aidbox.app/static/aidbox.html](https://aidbox.app/static/aidbox.html). See the [tutorial](../getting-started/run-aidbox/run-aidbox-in-aidbox-sandbox.md) on how to create a new box.
