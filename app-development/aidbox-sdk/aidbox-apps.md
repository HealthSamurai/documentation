...
{% hint style="warning" %}
It is a deprecated option to create custom resources via [Entity/Attribute](../../deprecated/entity-attribute/entities-and-attributes.md) approach.
{% endhint %}
