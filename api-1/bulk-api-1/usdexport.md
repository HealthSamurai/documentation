...
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `_outputFormat` | Specifies format in which the server generates files. <br /> Supported formats: <br /> <ul><li>`application/fhir+ndjson` — `.ndjson` files will be saved </li> <li>`application/fhir+ndjson+gzip`  — `.ndjson.gzip` files will be saved </li></ul>
