...
{% hint style="info" %}
Aidbox REST API doesn't ignore`id` and treats it as all other attributes in contrast to FHIR API. Read more about differences [here](../../../getting-started/aidbox-and-fhir-formats.md).
{% endhint %}
