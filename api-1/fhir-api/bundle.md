...
See more about the difference between Aidbox and FHIR formats (`/...` and `/fhir/...` endpoints) in the [aidbox-and-fhir-formats.md](../../getting-started-1/aidbox-and-fhir-formats.md "mention") page.
