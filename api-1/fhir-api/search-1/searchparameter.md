...
{% hint style="warning" %}
We do not support [FHIR SearchParameters](https://build.fhir.org/searchparameter.html). \
...
* [jsonknife](searchparameter.md#jsonpath-vs-jsonknife) expression containing path in the resource to search for
