...
* [postgis](https://github.com/postgis/postgis) — Support storing, indexing, and querying geographic data. Used by [\_location](../../api/search/other/location-search.md) search parameter only.
