...
Firstly, you need to install local Aidbox.dev. See the full instruction how to [install Aidbox.dev](../installation/setup-aidbox.dev.md) and [how to use Rest API]()
