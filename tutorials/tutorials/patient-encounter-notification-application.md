...
Firstly, you need to install local Aidbox. See the full instruction on how to [install Aidbox locally](../../getting-started/run-aidbox/run-aidbox-locally-with-docker.md) and [how to use Rest API](https://docs.aidbox.app/api-1/api)
