...
In this tutorial we will create an [HL7 v2 pipeline](../../modules-1/hl7-v2-integration/hl7-v2-pipeline.md) to parse, map and persist Patient resources to your Aidbox database.
