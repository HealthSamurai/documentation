...
This operation translates to [aidbox.mdm/match RPC](../../../deprecated/zen-related/rpc-reference/aidbox/mdm/aidbox.mdm-match.md) call. The RPC has simpler syntax and you can adjust threshold values. Consider using it if you are not required to use FHIR syntax.
...
{% content-ref url="../../../deprecated/zen-related/rpc-reference/aidbox/mdm/aidbox.mdm-match.md" %}
[aidbox.mdm-match.md](../../../deprecated/zen-related/rpc-reference/aidbox/mdm/aidbox.mdm-match.md)
{% endcontent-ref %}
