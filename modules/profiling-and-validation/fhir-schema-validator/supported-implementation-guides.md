...
Implementation Guide for exchanging Transitions of Care minimum data set for patients transitioning between health organizations. (built Fri, Mar 28, 2025 13:46+0000+00:00)
...
This project is meant for creating and testing profiles used for LOGEX's FHIR integration
...
Data Quality Assurance - Outburn
...
OH MI FHIR IG package for internal testing
...
eRezeptAbgabedatensatz 1.5.0 zum 01.10.2025
...
Tämä opas sisältää eri Kanta-palveluissa käytettävät yhteiset FHIR- ja REST-rajapintamääärittelyt 
...
An Implementation Guide providing the foundational guidance for order-based workflow FHIR interoperability (built Mon, Apr 7, 2025 15:35+0000+00:00)
...
Generic FHIR artifacts for VZVZ projects
...
臺灣核心實作指引(TW Core IG) (built Thu, Dec 12, 2024 12:41+0800+08:00)
...
This IG defines the extensions that the tools use internally. Some of these extensions are content that are being evaluated for elevation into the main spec, and others are tooling concerns (built Thu, Apr 17, 2025 05:34+1000+10:00)
...
This is a Healthedata1 sandbox for creation of resources and examples (built Tue, Feb 18, 2025 15:14+0000+00:00)
...
Ressources de conformité basées sur le modèle d'exposition de l'Annuaire Santé. (built Mon, Apr 14, 2025 13:04+0000+00:00)
...
Expansions for the R3 version of the FHIR standard
...
Die Basisprofile bilden die Grundlage zur Ablösung der bisherigen Formtexte für die Gesetzliche Unfallversicherung.
...
These requirements were originally developed, balloted, and published in FHIR DSTU2 as part of the Office of the National Coordinator for Health Information Technology (ONC) sponsored Data Access Framework (DAF) project. For more information on how DAF became US Core see the US Core change notes. (built Fri, Dec 13, 2024 16:53+0000+00:00)
...
NL package of FHIR STU3 conformance resources for iWlz.
...
Definitions (API, structures and terminologies) for the R3 version of the FHIR standard
...
This FHIR-IG contains all profiles necessary to characterize AI-Services and their artefacts needed. This project is work in progress and will change over time.
...
Web Service that provides the Social Care context for a Shared Health and Care Record
...
This Guide describes mednet interfaces (built Fri, Nov 1, 2024 10:57+0100+01:00)
...
IL core project version 0.17.1 with updated SearchParameters - for testing purposes
...
An Implementation Guide for the HL7® Austria FHIR® Core Profiles. (built Mon, Jan 27, 2025 10:36+0000+00:00)
...
Profiles tailored for the Kids First Data Resource Center
...
Implementation guide for eTOC based on CH ORF (built Wed, Dec 18, 2024 10:50+0000+00:00)
...
Danish municipalities implementation guide for §140 rehabilitation reporting (built Thu, Oct 31, 2024 15:36+0100+01:00)
...
Medizininformatik Initiative - Modul Meta
...
Specifikacije svih resursa, poruka, proširenja, primjera i terminologije.
...
Implementation Guide for CH ATC (Audit Trail Consumption) (built Wed, Dec 18, 2024 12:52+0000+00:00)
...
Nictiz NL package of FHIR STU3 conformance resources for Images.
...
FHIR artefacts for the Smart4Health project (https://smart4health.eu/).
...
Finnish HL7 FHIR implementation guide for scheduling, published and maintained by HL7 Finland (built Sun, Feb 9, 2025 17:06+0000+00:00)
...
Der E-Rechnung-Fachdienst ermöglicht es Versicherten (allgemein Rechnungsempfängern) Rechnungen von Leistungserbringern.
...
Medizininformatik Initiative - Modul Mikrobiologie
...
Implementation guidance for creating Clinical Practice Guidelines with formal artifacts to facilitate sharing and implementation of the guideline (built Tue, Nov 26, 2024 16:14+0000+00:00)
...
eHealth Platform Federal infsec Profiles (built Tue, Nov 12, 2024 09:23+0100+01:00)
...
E-Rezept Spezifikation für den EU Austausch
...
Implementation Guide for the Israeli Health Data Portability law - initial release, for testing purposes only - 0.0.1
...
Validate against EMA QRD business rules
...
BC Patient Summaries Exchange from EMRs
...
Ovaj vodič za implementaciju integracijskog sučelja opisuje funkcionalnosti usluge za upravljanje slučajevima.
...
KBV-Basis-Profile-Terminologie 1.7.1
...
Projekt Basisprofilierung (HL7 Deutschland e.V.)
Fassung für das Abstimmungsverfahren zur Kommentierung (11-12/2018) mit Ergänzung der Geschlechts-Differenzierung divers/unbestimmt
...
This project contains HL7 FHIR compliant profiles for the information standard Contraindications and hypersensitivities.
...
API to fully digitise the referral and discharge process where social care involvement is required to safely discharge a patient from an acute setting.
...
KDS Modul Consent Release 2025.0.1
...
Implementation Guide for the eMedication in Switzerland. (built Tue, Dec 17, 2024 21:31+0000+00:00)
...
This WHO Digital Documentation of COVID-19 Certificates (DDCC) Implementation Guide details how to use Health Level 7 (HL7) Fast Healthcare Interoperability Resources (FHIR) for consistent digital representation of COVID-19 certificates and interoperability. (built Wed, Dec 18, 2024 16:39+0100+01:00)
...
STU3 Assets from our Github account and Care Connect Profiles have been added from Github https://github.com/nhsconnect/CareConnect-profiles/tree/develop
...
Vermittlung von telemedizinischen Leistungen durch Dritte gemäß §370a, Absatz 2, SGB V
...
Communicate Continuous Glucose Monitoring (CGM) data using FHIR (built Mon, Mar 31, 2025 13:42+0000+00:00)
...
A core set of FHIR resources profiled for use in Finland, published and maintained by HL7 Finland (built Thu, Feb 6, 2025 19:03+0200+02:00)
...
FHIR Core package - the NPM package that contains all the definitions for the base FHIR specification (built Tue, Apr 1, 2025 12:16+1100+11:00)
...
The SDC specification provides an infrastructure to standardize the capture and expanded use of patient-level data collected within an EHR. (built Tue, Dec 17, 2024 01:47+0000+00:00)
...
Showcase of Extension of MIABIS on FHIR project
...
DEMIS-Integrierte Genomische Surveillance (IGS)
...
Mapping of the ASIC data onto FHIR ressources 
...
2025 proposed updates to the Enhancing Oncology Model IG
...
新增condition、valueset、codesystem
...
This is a test project and a test package
...
The DK MedCom Document IG (built Fri, Nov 15, 2024 06:43+0100+01:00)
...
An Implementation Guide which describes how to utilize GDHCN and IPS for verifiable health documents during pilgrimage. (built Thu, Apr 25, 2024 17:22+0000+00:00)
...
FHIR® Implementation Guide for the Electronic Laboratory Report of the Swiss Federal Office of Public Health (built Wed, Mar 26, 2025 07:47+0000+00:00)
...
For further information see the C-CDA specification here: http://www.hl7.org/implement/standards/product_brief.cfm?product_id=408. (built Tue, Dec 17, 2024 21:40+0000+00:00)
...
CCA IG (built Tue, Nov 17, 2020 10:49+1300+13:00)
...
Diese Version ist produktiv und wird vom EMIGA-Backend unterstützt. 
...
**RETIRED** General Nictiz repository of FHIR STU3 conformance resources. **RETIRED**
...
Ovaj vodič za implementaciju integracijskog sučelja opisuje funkcionalnosti usluge za upravljanje posjetama.
...
This implementation guide is provided to support the use of FHIR®© for clinical requesting and ordering in an Australian context. , and defines the minimum set of constraints on the FHIR resources to create the AU eRequesting profiles. (built Wed, Mar 12, 2025 04:23+0000+00:00)
...
FHIR Profiles used for exposing Practitioner & Study information from clinicalsite.org
...
* refactored Strahlentherapie-Bestrahlungs-Extension in eigene MII-Prozeduren für Strahlentherapie und Nuklearmedizin. 
* neue OPS-ValueSets für alle Strahlentherapie-Codes (8-52*) und Nuklearmedizinischen Codes (8-53)
* enthält sowohl alte und neue Profile zum Abgleich. 
...
Schulungsaufgaben zum Profiling
...
KBV-Basis-Profile-Terminologie
...
Ontario Laboratory Information System - R4
...
Nictiz NL package of FHIR STU3 conformance resources for BgZ.
...
Die Audit-Event-Service-Spezifikation der elektronischen Patientenakte
...
New Zealand base profiles (built Wed, Aug 14, 2024 09:17+1200+12:00)
...
Kanta Hyvinvointisovellusten rajapinta potilastietoihin FHIR R4 määrittelyt (profiilit, laajennokset, ValueSet:it ja CodeSystem:it).
...
Ontario Mental Health and Addictions Provincial Data Set 2.0
...
Guidelines for conveying coverage requirements to clinicians when planning treatment. (built Fri, Dec 20, 2024 21:03+0000+00:00)
...
Description of IG (built Thu, Mar 30, 2023 12:51+0000+00:00)
...
The DK MedCom Terminology IG (built Tue, Nov 12, 2024 08:09+0100+01:00)
...
This IG provides detailed guidance that helps implementers use FHIR-based interactions to support specific exchanges of clinical data between providers and payers (or other providers). (built Tue, Feb 11, 2025 03:51+1100+11:00)
...
CodeX™ Radiation Therapy is an initiative intended to assemble a core set of structured data elements for radiation therapy electronic health records. (built Mon, Feb 17, 2025 23:18+0000+00:00)
...
Guía IPS homologada para la realidad Chilena. (built Sat, Jan 11, 2025 20:04-0300-03:00)
...
Common terminology used by HIP FHIR services (built Tue, Oct 22, 2024 03:28+0000+00:00)
...
Contains the conformance resources and Questionnaires for Outcome Based Care.
...
Abgabedaten-Modell für die eVerordnung Hilfsmittel
...
Terminology managed by the NIHDI (RIZIV/INAMI) in various publications, such as https://www.inami.fgov.be/SiteCollectionDocuments/instructions_facturation_electronique.pdf  (built Mon, Feb 17, 2025 19:20+0100+01:00)
...
The Danish eHealth Infrastructure Implementation Guide defines a set of FHIR profiles with extensions and bindings needed to create interoperable, quality-focused applications. (built Tue, Apr 29, 2025 12:17+0000+00:00)
...
DaVinci Payer Data Exchange (PDex) US Drug Formulary" (built Wed, Feb 26, 2025 17:11+0000+00:00)
...
Da Vinci PDex Plan Net (built Tue, Feb 25, 2025 19:12+0000+00:00)
...
This project contains the profiles and packages defined as part of the GP Connect access structured record capability.
...
FHIR STU3 conformance resource for NICE based on zib release 2017
...
Basisprofil Tiplu (DE) (R4) Dev-Stage
...
Medizininformatik Initiative - Modul Diagnose
...
Belgian Patient profiles (built Mon, Mar 24, 2025 15:54+0100+01:00)
...
Abrufen eines Vermittlungscodes über ein Praxisverwaltungssystem (PVS)
...
Expansions for the 6.0.0-ballot3 version of the FHIR standard (built Tue, Apr 1, 2025 12:16+1100+11:00)
...
De zorgviewer biedt zorgverleners een 360° beeld van de patiënt of cliënt. Opgebouwd uit alle beschikbare zorginformatie, waarvoor de patiënt of cliënt toestemming heeft gegeven. (built Tue, Apr 15, 2025 14:12+0000+00:00)
...
Medizininformatik Initiative - Modul Prozedur
...
A Guide to HL7 IG Publisher's -go-publish feature (built Thu, Feb 20, 2025 21:17-0800-08:00)
...
FHIR® Implementation Guide for Laboratory Reports in Switzerland (built Wed, Dec 18, 2024 08:52+0000+00:00)
...
A brief description of what udsplus is about (probably the same text as in your readme) (built Fri, Mar 28, 2025 22:44+1100+11:00)
...
Guidelines for using the SMART App Launch mechanism in Finland. (built Thu, Feb 6, 2025 22:27+0200+02:00)
...
Guidelines for using the SMART App Launch mechanism in Denmark. (built Sat, Feb 1, 2025 20:09+0100+01:00)
...
Medizininformatik Initiative - Modul Labor
...
This project includes the extensions created by BCM for the eMERGE Clinical Genetics Reports FHIR specification.
...
Profile für die eVO13 (Heilmittelverordnung Muster 13)
...
This implementation guide defines profiles, operations and guidance for the use of CQL with FHIR, both as a mechanism for querying, as well as inline and integrated usage as part of knowledge artifacts. (built Mon, Dec 16, 2024 21:01+0000+00:00)
...
Les nomenclatures des objets de Sante (built Tue, Feb 11, 2025 10:50+0000+00:00)
...
US Situational Awareness Framework for Reporting (US SAFR) (built Fri, Mar 28, 2025 19:37+0000+00:00)
...
PHSA - BC and Yukon Immunization Distribution Service (IDS)
...
Defines and exposes all HL7 terminologies managed through the unified terminology governance process (built Wed, Apr 30, 2025 19:35-0600-06:00)
...
Defines and exposes all HL7 terminologies managed through the unified terminology governance process (built Wed, Jan 22, 2025 18:14-0700-07:00)
...
mein Testprojekt bei der GMDS-Tagung
...
Profiles for integrating into various EHR systems, mainly Finnish Kanta
...
SMART Trust Implementation Guide (built Thu, Dec 19, 2024 12:42+0000+00:00)
...
Person-Centered Outcomes (PCO) FHIR Implementation Guide (built Fri, Mar 28, 2025 21:02+0000+00:00)
...
Implementation guide CH AllergyIntolerance (R4) (built Wed, Dec 18, 2024 09:25+0000+00:00)
...
ON eReC Specifications:

Latest: https://simplifier.net/guide/ca-on-ereferral-r4-iguide?version=0.12.1

Other:

https://simplifier.net/guide/ca-on-ereferral-r4-iguide/Index?version=0.12.0 

https://simplifier.net/guide/ca-on-ereferral-r4-iguide/Index?version=0.11.1
...
EMIGA Organizationsverzeichnis MVP Version
...
Kanta Potilastietovarannon ajanvarauksen FHIR R4 määrittelyt (profiilit, laajennokset, ValueSet:it ja CodeSystem:it).
...
Ontario eReferral-eConsult Specification

Click https://simplifier.net/guide/ca-on-ereferral-r4-iguide/Index?version=0.12.0 to access the most recently published IG (v0.12.0)

Click https://simplifier.net/guide/ca-on-ereferral-r4-iguide/Index?version=0.11.1 to access v0.11.1
...
Núcleo de Interoperabilidad de Datos del Ministerio de Salud de Chile (built Tue, Feb 4, 2025 08:27-0300-03:00)
...
醫療保險理賠實作指引 (built Tue, Jul 23, 2024 21:52+0800+08:00)
...
PoC for Shared Care Record  and Eco-System Platform (ESP)
...
Updated Conformance on Lab Observations
...
KLChildren contains the specification for reporting data from the Danish health promotion and disease prevention program for children in Denmark (Sundhedsplejen). Data is reported to FK Gateway (built Thu, Oct 31, 2024 20:27+0100+01:00)
...
EMIGA Verzeichnisdienstinhalte. 
...
This IG is built in order to describe the IG tooling in Austria. (built Mon, Jan 20, 2025 15:36+0100+01:00)
...
COVID-19-related FHIR resources and IG material published by D4L Data4Life gGmbH.
...
Implementation Guide for the Mobile access to Health Documents (EPR FHIR) Profile for the Swiss EPR (built Wed, Dec 18, 2024 12:07+0000+00:00)
...
This guide describes how the Laboratory Report can be represented for the purpose of the MyHealthEu. (built Thu, Mar 20, 2025 14:16+0100+01:00)
...
The DK MedCom Messaging IG (built Thu, Nov 7, 2024 08:11+0100+01:00)
...
Nictiz NL package of FHIR STU3 conformance resources for eOverdracht information standard. Includes dependency on Zib2017.
...
MedMij Dental Care 1.0.0-alpha.3
...
Nictiz NL package of FHIR STU3 conformance resources for pre-adopted profiles from HCIM Release 2020 to be used within a HCIM Release 2017 context. Please note: pre-adoption is strongly discouraged and should only be considered in exceptional circumstances.
...
Guia de Implementação da SES GO - CORE (built Fri, Jan 17, 2025 09:49-0300-03:00)
...
Nictiz NL package of FHIR STU3 conformance resources for eAfspraak.
...
Guía de Implementación Versión de Desarrollo Sobre STU 1, para los perfiles Core que se van a requerir a nivel de desarrollo Nacional para Sistemas que Intercambien datos en estandar FHIR-R4 (built Wed, Dec 11, 2024 10:23-0300-03:00)
...
Ressources de conformité basées sur le modèle d'exposition 3.0 du ROR (built Mon, Mar 17, 2025 13:22+0000+00:00)
...
Pan-Canadian Patient Summary (PS-CA) 2.1.0 DFT-Ballot Release to support  Patient Summary in Canada
...
Guidance on how to create longitudinal personal health records using FHIR.  Exporting, file formats, patient examples, and more. (built Thu, Apr 3, 2025 14:45+0000+00:00)
...
Base SMART Guidelines implementation guide to be used as the base dependency for all SMART Guidelines IGs (built Wed, Apr 2, 2025 12:10+0200+02:00)
...
Danish municipalities implementation guide for reporting §119 disease prevention and health promotion (built Mon, Jun 24, 2024 12:34+0200+02:00)
...
Reprezentace DASTA 4 pomocí FHIR.
...
Basis profiles developed by HL7 Norway.
...
maccabi medication request for maccabi dent. Test by Itay Nachliel
...
An Implementation Guide for the HL7® Austria FHIR® Core Profiles. (built Fri, Jan 24, 2025 14:19+0000+00:00)
...
Brazil's BR-Core R4 Implementation Guide Repository.
...
Implementation Guide for the Ontario DHDR HL7 FHIR 4.0.2
...
The Fast Healthcare Interoperability Resource (FHIR) Quality Measure Implementation Guide (this IG) describes an approach to representing Quality Measures (QMs) using the FHIR Clinical Reasoning Module and Clinical Quality Language (CQL) in the US Realm. However, this Implementation Guide can be usable for multiple use cases across domains, and much of the content is likely to be usable outside the US Realm. (built Mon, Dec 16, 2024 21:47+0000+00:00)
...
Guidelines for conveying coverage requirements to clinicians when planning treatment (built Wed, Dec 11, 2024 18:43+0000+00:00)
...
JP-CORE V1.1.0 for release candidate
...
US Prescription Drug Monitoring Program (PDMP) FHIR IG (built Tue, Oct 15, 2024 18:20+0000+00:00)
...
FHIR Implementation Guide which defines the documents for the exchange of medication information in the context of the Swiss eMedication service (built Tue, Jan 21, 2025 10:57+0000+00:00)
...
mCODE™ (short for Minimal Common Oncology Data Elements) is an initiative intended to assemble a core set of structured data elements for oncology electronic health records. (built Sun, Feb 16, 2025 19:03+0000+00:00)
...
臺灣健保癌症用藥事前審查實作指引(Taiwan NHI Cancer Prior Authorization Support Implementation Guide，TWPAS IG) (built Thu, Dec 12, 2024 16:57+0800+08:00)
...
Perfis dos recursos FHIR utilizados no barramento de dados da Sami com seus parceiros clínicos
...
Die Kommentierungs-Version der Stufe 5 der Informationssysteme im Krankenhaus (ISiK) Festlegung
...
Ontario eReferral-eConsult Implementation Guide
...
* Local, State, Tribal and Federal Public Health Agencies (built Wed, Oct 30, 2024 20:32+0000+00:00)
...
Esta Guía de Estandares de Informacionde Salud desarrolla el Decreto Excento 231 del DEIS que reemplaza la norma técnica 820, y tiene como finalidad determinar compatibilidad de esta con el estándar FHIR (built Fri, Nov 29, 2024 11:08-0300-03:00)
...
The DK MedCom Carecommunication IG (built Thu, Nov 7, 2024 14:18+0100+01:00)
...
Project for self-assessment via App for COVID-19
...
Les nomenclatures des objets de Santé sont mises à disposition du secteur santé-social par l’agence du numérique en santé (built Wed, Apr 2, 2025 10:28+0000+00:00)
