...
This new validation engine is set to replace the existing [Zen Schema Validator](broken-reference) and [JSON Schema](../../../deprecated/other/profiling-with-aidboxprofile.md) validator. \
\
