...
* [aidbox.validation/resources-batch-validation-task](validation-api.md#aidbox.validation-batch-validation-result) - run validation with [Aidbox Workflow](../../deprecated/zen-related/workflow-engine/workflow/)
...
You can also [run](../../deprecated/zen-related/workflow-engine/task/aidbox-predefined-tasks.md#aidbox.validation-resource-types-bath-validation-workflow) workflow directly to achieve the same result. &#x20;
