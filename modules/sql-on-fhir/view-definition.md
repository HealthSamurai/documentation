...
This example only scratches the surface. For more complex examples, see[query-data-above-view-definitions.md](query-data-above-view-definitions.md). For an in-depth overview of ViewDefinition's structure consult[reference.md](reference.md).
