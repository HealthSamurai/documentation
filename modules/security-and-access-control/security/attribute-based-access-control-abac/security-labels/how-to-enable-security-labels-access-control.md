...
{% hint style="info" %}
See more details related the [running Aidbox locally](https://github.com/Aidbox/documentation/blob/master/modules/security-and-access-control/security-labels/broken-reference/README.md)
{% endhint %}
...
To create the access policy, run the following request in the [REST Console](../../../../../overview/aidbox-ui/rest-console.md#rest-console).
...
To create the Patient, run the following request in the [REST Console](../../../../../overview/aidbox-ui/rest-console.md#rest-console).
...
To create the Encounter, run the following request in the [REST Console](../../../../../overview/aidbox-ui/rest-console.md#rest-console).
...
To create the Observation, run the following request in the [REST Console](../../../../../overview/aidbox-ui/rest-console.md#rest-console).
