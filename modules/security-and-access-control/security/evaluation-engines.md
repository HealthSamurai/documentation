...
To test matcho DSL without creating AccessPolicy and sending a request, you can use the [$matcho](/api/other/usdmatcho.md) endpoint.
    ...
    matcho:
      ...
      params:
        ...
        $one-of:
          ...
          - id: present?
    ```
*   **$reference** — parse `Reference` or string into [aidbox format](../../../storage/other/aidbox-and-fhir-formats.md#references). It is useful to map FHIR reference into resourceType and id like this:
