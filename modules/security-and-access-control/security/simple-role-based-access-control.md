...
You can inspect request object [using `__debug` query parameter](../../../readme-1/debug.md#__debug-query-string-parameter).

## Guide: flexible RBAC

{% content-ref url="../../../readme-1/rbac/role-based-access-policies.md" %}
[role-based-access-policies.md](../../../readme-1/rbac/role-based-access-policies.md)
{% endcontent-ref %}
