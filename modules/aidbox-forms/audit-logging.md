...
* [setup audit logging](../security-and-access-control/audit/setup-audit-logging.md)
...
For using user-token you should setup [TokenIntrospector](../../modules/security-and-access-control/how-to-guides/token-introspection/) or [IdentityProvider](../security-and-access-control/set-up-external-identity-provider/) for validating this token.
