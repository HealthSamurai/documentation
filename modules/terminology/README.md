...
{% content-ref url="../../deprecated/zen-related/fhir-terminology-repository/ftr-specification.md" %}
[ftr-specification.md](../../deprecated/zen-related/fhir-terminology-repository/ftr-specification.md)
{% endcontent-ref %}
