...
1. FHIR portal. An internal website to manage SMART on FHIR Apps that can be integrated with the patient portal.
1. App Gallery. A website that shows SMART on FHIR apps available for patients.&#x20;
