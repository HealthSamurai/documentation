...
Smartbox is distributed as an aidbox configuration project on top of Aidbox. It follows [Aidbox multitenancy approach](../../security-and-access-control/security/multitenancy.md) on API constructor.
