...
It is possible to setup any SMTP provider using `AidboxConfig` resource, also there's [Postmark](../../../readme/integration-toolkit-tutorials/postmark-integration.md) and [Mailgun](../../../readme/integration-toolkit-tutorials/mailgun-integration.md) configuration via environment variables.
