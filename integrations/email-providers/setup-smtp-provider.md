...
{% hint style="info" %}
To enable SMTP please specify optional environment variable`AIDBOX_BASE_URL.`The full list of variables is available [here](../../getting-started/run-aidbox/run-aidbox-locally-with-docker.md).
{% endhint %}
