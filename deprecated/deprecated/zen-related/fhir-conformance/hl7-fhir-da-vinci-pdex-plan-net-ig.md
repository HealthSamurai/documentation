...
To comply with the implementation guide you need to load PlanNet profiles and create SearchParameters. Aidbox [registers extensions](https://docs.aidbox.app/modules/first-class-extensions) for the loaded profiles on the fly.
