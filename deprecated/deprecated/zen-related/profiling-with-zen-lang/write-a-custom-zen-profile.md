...
Those schemas must be tagged with `zen.fhir/profile-schema`, describe data structure in the [Aidbox format](../../../../api-1/api/other/aidbox-and-fhir-formats.md), and conform to the following schema:
