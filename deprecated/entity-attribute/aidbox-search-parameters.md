...
{% hint style="warning" %}
Be aware of the [Aidbox format](../../../../../storage/other/aidbox-and-fhir-formats.md) in "expression".&#x20;
{% endhint %}
...
If you have defined [first-class extension](../../../../../deprecated/entity-attribute/first-class-extensions.md), you have to use Aidbox format for the SearchParameter expression. If you use FHIR format, you don't need to create Attribute and the `expression` path should be in FHIR format.
...
If you use [Zen IG](../../../../../deprecated/zen-related/aidbox-zen-lang-project/aidbox-project-environment-variables/zen-configuration.md) then first-class extensions are generated from zen-schemas. You have to use Aidbox format for the custom SearchParameter `expression` (check tab #3 in the example above).
