...
Aidbox uses [PostgreSQL](https://www.postgresql.org/) database for storage. Most of resource data is contained in [_resource_](../../storage/database.md) column with [_jsonb_](https://www.postgresql.org/docs/current/datatype-json.html) type.
...
Use [\_explain](/api/search/search-parameters-list/_explain.md) to find out SQL query generated by this request
...
Aidbox provides a mechanism to manage indexes automatically using [Aidbox configuration project](../../deprecated/zen-related/aidbox-zen-lang-project/).
...
This RPC runs [workflow](../../deprecated/zen-related/workflow-engine/workflow/) that creates indexes requested by your configuration. And removes indexes not requested.
...
{% content-ref url="../../deprecated/zen-related/aidbox-zen-lang-project/zen-indexes.md" %}
[zen-indexes.md](../../deprecated/zen-related/aidbox-zen-lang-project/zen-indexes.md)
{% endcontent-ref %}
