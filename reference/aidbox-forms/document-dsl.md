...
> This feature can be configured via [api-constructor](../../deprecated/zen-related/aidbox-api-constructor.md) in zen-project.
...
2. Create [`AwsAccount`](../../storage/other/s3-compatible-storages/aws-s3.md) or [`GcpServiceAccount`](../../storage/other/s3-compatible-storages/gcp-cloud-storage.md)
