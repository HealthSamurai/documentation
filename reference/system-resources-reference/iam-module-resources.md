...
<tr><td width="290">type</td><td width="70">0..1</td><td width="150">string</td><td>The type of client application.</td></tr>
...
<tr><td width="290">description</td><td width="70">0..1</td><td width="150">string</td><td>A description of the client application for administrative purposes.</td></tr></tbody>
</table>
...
<tr><td width="290">start</td><td width="70">0..1</td><td width="150">dateTime</td><td>Time when this grant was created.</td></tr></tbody>
</table>
...
<strong>Allowed references</strong>: Client</td></tr>
<tr><td width="290">end</td><td width="70">0..1</td><td width="150">dateTime</td><td>Time when the session ended or will end.</td></tr></tbody>
</table>
...
<tr><td width="290">params</td><td width="70">0..1</td><td width="150">Object</td><td></td></tr></tbody>
</table>
...
<tr><td width="290">userinfo_header</td><td width="70">0..1</td><td width="150">string</td><td>Header to be used when calling the userinfo endpoint.</td></tr>
...
<tr><td width="290">jwks_uri</td><td width="70">0..1</td><td width="150">string</td><td>URI where the provider's JSON Web Key Set can be retrieved.</td></tr></tbody>
</table>
