...
Access the [REST Console](rest-console.md) of the created box. Execute the following requests. Their meaning you can read in the [tutorial](../../user-management-1/auth/basic-auth.md#register-client).
