...
* [How-to guides](security-and-access-control-1/how-to-guides/README.md)
  * [External identity provider](security-and-access-control-1/how-to-guides/external-identity-provider/README.md)
    * [Aidbox](security-and-access-control-1/how-to-guides/external-identity-provider/aidbox.md)
    * [Okta](security-and-access-control-1/how-to-guides/external-identity-provider/configure-okta.md)
    * [Azure AD](security-and-access-control-1/how-to-guides/external-identity-provider/azure-ad.md)
    * [Keycloak](security-and-access-control-1/how-to-guides/external-identity-provider/keycloak.md)
  * [RBAC](security-and-access-control-1/how-to-guides/rbac/README.md)
    * [RBAC with JWT containing role](security-and-access-control-1/how-to-guides/rbac/role-based-access-control-with-jwt-containing-role.md)
    * [RBAC with ACL](security-and-access-control-1/how-to-guides/rbac/role-based-access-control-with-acl.md)
  ...
  * [Set-up access control when patient can see their own data](security-and-access-control-1/how-to-guides/sample-patient-can-see-its-own-data.md)
...
* [Background information](security-and-access-control-1/background-information/README.md)
  ...
  * [Debug access control](security-and-access-control-1/background-information/debug.md)
