...
* [How-to guides](security-and-access-control-1/how-to-guides/README.md)
  ...
  * [Set-up external identity provider](security-and-access-control-1/how-to-guides/set-up-external-identity-provider/README.md)
    * [Aidbox as an External identity Provider](security-and-access-control-1/how-to-guides/set-up-external-identity-provider/aidbox.md)
    * [Okta](security-and-access-control-1/how-to-guides/set-up-external-identity-provider/configure-okta.md)
    * [Azure AD](security-and-access-control-1/how-to-guides/set-up-external-identity-provider/azure-ad.md)
    * [Keycloak](security-and-access-control-1/how-to-guides/set-up-external-identity-provider/keycloak.md)
  * [Set-up Role-Based Access Control with JWT containing role](security-and-access-control-1/how-to-guides/role-based-access-control-with-jwt-containing-role.md)
