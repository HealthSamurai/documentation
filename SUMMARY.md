...
* [Auth](auth-betta/README.md)
  ...
  * [Scenarios](auth-betta/scenarios/README.md)
    ...
    * [Single Page Application](auth-betta/scenarios/single-page-application/README.md)
      * [Implicit Grant Flow](auth-betta/scenarios/single-page-application/implicit.md)
      * [Authorization Code Flow for SPA](auth-betta/scenarios/single-page-application/authorization-code-flow-for-spa.md)
    * [Web Application](auth-betta/scenarios/web-application.md)
    * [Mobile Application](auth-betta/scenarios/mobile-application.md)
    * [External Identity Providers](auth-betta/scenarios/external-identity-providers.md)
    * [SMART app](auth-betta/scenarios/smart-app.md)
  ...
  * [OAuth 2.0 Flows](auth-betta/oauth-2.0-flows/README.md)
