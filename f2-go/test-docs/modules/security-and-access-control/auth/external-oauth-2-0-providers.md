...
- [Aidbox](../../../tutorials/security-access-control-tutorials/aidbox.md)
- [Okta](../../../tutorials/security-access-control-tutorials/okta.md)
- [Microsoft Azure AD](../../../tutorials/security-access-control-tutorials/azure-ad.md)
...
If JWT is valid, Aidbox will put it's claims into the request object under `jwt` key, so you'll be able to access them with [AccessPolicy checks](../../../access-control/authorization/access-policies.md). If the token failed validation (it's expired or signature isn't correct) then the client will get a 401 "Unauthorised" response.
